...
public class BuildablesTest {
    ...
    public void buildShieldWithSunstoneA() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res;
        res = dmc.newGame("d_BuildablesTest_BuildShieldWithSunstone", "c_BuildablesTest_BuildShieldWithSunstone");
    ...
    @Test
    @Tag("5-4")
    @DisplayName("Test building a shield with a key instead of a Sunstone")
    public void buildShieldWithSunstoneB() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_BuildablesTest_BuildShieldWithKey", "c_BuildablesTest_BuildShieldWithKey");
