...
public class TestUtils {
    ...
    public static DungeonResponse kill3ZombieSequence(DungeonManiaController controller, String configFile) {
        DungeonResponse response = controller.newGame("enemyGoal/d_enemyGoalTest_testPass", configFile);
        List<EntityResponse> entities = response.getEntities();
        assertEquals(1, countEntityOfType(entities, "player"));
        assertEquals(3, countEntityOfType(entities, "zombie_toast"));
